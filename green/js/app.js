...
Game.startScreen = function startScreen() {
  this.board       = $('.board');
  this.startText   = $('<p class="starttext">Welcome to Balloon Burst Lev 1. The aim of the game is to pop maximum balloons before they fly away. You will get only 40sec , so Hurry Up!!</p>');
...
Game.gameOverMessage = function gameOverMessage() {
  this.messageText = $('<p class="gameover">LEVEL 1 COMPLETE!</p>');
...
Game.resetButton1Action = function() {
	var a=Game.highScore;
	localStorage.setItem("myValue1",a);
  window.location.href="indexl2.html";
