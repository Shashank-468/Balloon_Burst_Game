...
Game.startScreen = function startScreen() {
  this.board       = $('.board');
  this.startText   = $('<p class="starttext">Welcome to Balloon Burst Level 3. The aim of the game is to pop maximum balloons before they fly away. You will get only 20 seconds, so Hurry Up!!</p>');
...
Game.resetButton1 = function resetButton1() {
  this.resetButton1   = $('<p class="reset-button2">Score</p>');
...
Game.resetButton1Action = function() {
	var d=localStorage.getItem("myValue1");
	localStorage.setItem("myValue1",d);
	var e=localStorage.getItem("myValue2");
	localStorage.setItem("myValue2",e);
	var f=Game.highScore;
	localStorage.setItem("myValue3",f);
